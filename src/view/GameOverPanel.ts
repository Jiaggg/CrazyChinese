...
class GameOverPanel extends BasePanel{
    ...
    public initPanel():void{
        ...
        this.helpBtn2 = new EButton(this,"helpBtn",this.alert1, null, "",30,1);
        this.helpBtn2.x = 20;
        this.helpBtn2.y = 200;
        ...
        this.shopBtn2 = new EButton(this,"shopBtn",this.alert2, null, "",30,2);
        this.shopBtn2.x = 150;
        this.shopBtn2.y = 200;
        this.addChild(this.shopBtn2);   
        this.shopBtn2.alpha = 0;

        this.fbBtn2 = new EButton(this,"fbBtn",this.alert3, null, "",30,3);
        this.fbBtn2.x = 270;
        this.fbBtn2.y = 200;
        this.addChild(this.fbBtn2);  
        this.fbBtn2.alpha = 0; 

        this.setBtn2 = new EButton(this,"setBtn",this.alert4, null, "设置",30,1);
        ...
        this.helpBtn = new EButton(this,"helpBtn",null, null, "",30,1);
        this.helpBtn.x = 20;
        ...
        this.shopBtn = new EButton(this,"shopBtn",this.tipsEffect2, null, "",30,2);
        this.shopBtn.x = 150;
        this.shopBtn.y = this.h - this.shopBtn.height - 20;
        this.addChild(this.shopBtn);   
        this.shopBtn.visible = false;

        this.fbBtn = new EButton(this,"fbBtn",this.tipsEffect3, null, "",30,3);
        this.fbBtn.x = 270;
        this.fbBtn.y = this.h - this.fbBtn.height - 20;
        this.addChild(this.fbBtn);   
        this.fbBtn.visible = false;

        this.setBtn = new EButton(this,"setBtn",this.tipsEffect4, null, "设置",30,1);

...
class EButton extends egret.DisplayObjectContainer {
    ...
    */
    public constructor(context: any, imgName: string, backFun: Function = null, descStr: string = "", fontSize: number = UIEnum.FontSize.buttonSize, cartoonType: number = 1, assetsName: string = "assets") {
        super();
